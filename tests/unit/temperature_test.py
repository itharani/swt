...
class TestTemperatureConversions(unittest.TestCase):
    ...
    def test_celsius_to_fahrenheit(self):
        ...
        self.assertAlmostEqual(celsius_to_fahrenheit(56.7), 134.06)  # Random decimal
